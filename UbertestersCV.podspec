#
# Be sure to run `pod lib lint Ubertesters.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/woci/Ubertesters"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "woci" => "wocy01@gmail.com" }
  s.source           = { :git => "https://github.com/woci/Ubertesters.git", :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'Ubertesters' => ['Ubertesters/Assets/*.png']
  # }
